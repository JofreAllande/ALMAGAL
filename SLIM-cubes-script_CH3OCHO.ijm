...
path="/export/home/magma3/alma_guest/jofre.allande/data/2019.1.00195.L/sources/G318.9480-00.1969A/analysis/spectra/7MTM2TM1_header/maps/ch3ocho/";
...
run("SLIM Search", " range='selected_data' axislabel='Frequency' axisunit='Hz' molecules='JPL$"+molecule+"$Any$Any$Any$#' searchtype=add datafile='synchro_cubes.cub' datatype=CUBE_SYN");
...
run("SLIM Check Transitions", "molecules='CH3OCHO|1' freq='219827.8151' check='true'");
...
run("SLIM Check Transitions", "molecules='CH3OCHO|1' freq='219705.128' check='true'");
run("SLIM Check Transitions", "molecules='CH3OCHO|1' freq='220043.336' check='true'");
run("SLIM Check Transitions", "molecules='CH3OCHO|1' freq='220368.333' check='true'");
run("SLIM Check Transitions", "molecules='CH3OCHO|1' freq='220369.877' check='true'");
run("SLIM Check Transitions", "molecules='CH3OCHO|1' freq='220811.845' check='true'");
...
run("SLIM Save", "namefile='"+path+"methylformate.cub.slim'");
